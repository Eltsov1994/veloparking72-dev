        ...
        .on("click", function () {
            ...
            if (value) {
                url +=
                    ...
                    "&sub_category=true&description=true";
            }
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (
                    ...
                    $(".dropdown-cart").load("index.php?route=common/cart/info ul li", function(){
                        halfedPrice();
                        popupRefresh();
                        cartQuanter();
                        // Удаляем лоадер
    ...
    add: function (product_id) {
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json["success"]) {
                    popupBild('wishlist', json["success"]);
                    popupInit();

                    popup_open("popup-wishlist");
                }
    ...
    add: function (product_id) {
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json["success"]) {
                    popupBild('compare', json["success"]);
                    popupInit();

                    $("#compare-total").html(json["total"]);
                    popup_open("popup-compare");
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
                alert(
