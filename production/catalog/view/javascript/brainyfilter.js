  ...
  if (typeof BrainyFilter === "undefined") {
    var BrainyFilter = {
      ...
      init: function () {
        ...
        this.ajaxEnabled =
          !isIE() &&
          $(this.selectors.container).length &&
      ...
      initSliders: function () {
        $(".bf-slider-container").each(function () {
          var $slider = $(this),
            ...
            labels = BrainyFilter.sliderValues[id]
              .slice(0)
              .sort(function (a, b) {
                return a.n - b.n;
              }),
      ...
      changeTotalNumbers: function (data) {
        ...
        $form.find("select").each(function () {
          if (
            $(this).find("option").not(".bf-default,[disabled]").length === 0
          ) {
        ...
        $(this.filterFormId).each(function () {
          ...
          $form.find(".bf-attr-block-cont").each(function (i, v) {
            ...
            if (!$this.parent().is(".bf-sliding")) {
              ...
              wrapper.closest(".bf-sliding-cont").addClass("_active");
              firstInit = true;
            }
            if (enableSliding) {
              var count =
                $this.find(".bf-attr-filter").filter(":visible").length -
                visibleItems;
      ...
      shrinkBlock: function (block, items, disableAnim) {
        ...
        var visibleItems = parseInt($form.data("visible-items"));
        var count =
          $(block).find(".bf-attr-filter").filter(":visible").length -
          visibleItems;
        var height = 0;
        ...
        $(block).closest(".bf-sliding-cont").removeClass("_active");
      },
