...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_warranty'])) {
			$data['config_warranty'] = $this->request->post['config_warranty'];
		} else {
			$data['config_warranty'] = $this->config->get('config_warranty');
		}

		if (isset($this->request->post['config_exchange'])) {
			$data['config_exchange'] = $this->request->post['config_exchange'];
		} else {
			$data['config_exchange'] = $this->config->get('config_exchange');
		}
